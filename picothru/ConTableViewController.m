...
- (void)posttoken{
    ...
    NSArray *statusarray = [NSJSONSerialization JSONObjectWithData:statusdata options:NSJSONReadingAllowFragments error:nil];
    NSString *statusallow = [statusarray valueForKeyPath:@"status"];
    if ([statusallow isEqualToString:@"sucsess"]){
        UIAlertView *alert =
