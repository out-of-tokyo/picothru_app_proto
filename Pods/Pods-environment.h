...
// WebPay
#define COCOAPODS_POD_AVAILABLE_WebPay
#define COCOAPODS_VERSION_MAJOR_WebPay 1
#define COCOAPODS_VERSION_MINOR_WebPay 0
#define COCOAPODS_VERSION_PATCH_WebPay 4
